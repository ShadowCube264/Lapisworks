...
class LookupPWShapePage(PageWithOpPattern, type="hexcasting:lapisworks/pwshape"):
    ...
    def _post_root_lookup(self, info: ValidationInfo):
        ...
        self._patterns = [PatternInfo(id=ResourceLocation("lapisworks", "tmp"), startdir=Direction.NORTH_WEST, signature="aqaeawdwwwdwqwdwwwdweqaaaqaqwdddedeewqdedqewawewaw", is_per_world=True)]
        return self
